...
import com.example.smart_dispenser.LoginWindow;
import com.example.smart_dispenser.Smart_dispenserApplication;
...
public class dbconnect {
	...
	Table td = new Table();
	Table etd= new Table();
	String NurseSSn =(String) Smart_dispenserApplication.get().getUser() ;
